...
import styles from "./StockistDropdown.module.css";
...
const StockistIcon = () => (
  ...
  >
    ...
    <path
      ...
      className={styles.StockistIconTruck}
      strokeLinecap="round"
    ...
    <path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={styles.StockistIconLine}
    ></path>
    <path
      d="M-2 11H6"
      strokeLinecap="round"
...
function StockistDropdown() {
  ...
  return (
    <motion.nav
      className={styles.stockistDDContainer}
      initial={false}
    ...
    >
      ...
      >
        <motion.div
          className={styles.stockistDDSelected}
        ...
        {isStockist > 0 ? (
          <div
            className={styles.stockistDDAlertContainer}
            style={{ backgroundColor: theme.backgroundContainerFull }}
          >
            <div className={styles.stockistDDAlert}></div>
          </div>
        ) : (
          <></>
        )}
      ...
      >
        ...
        >
          <motion.div>
            <p className={styles.stockistDDSelected}>0</p>
          </motion.div>
        </motion.li>
...
export default StockistDropdown;
